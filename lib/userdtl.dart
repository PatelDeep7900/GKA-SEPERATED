          ...
          child: SingleChildScrollView(
            ...
            child: Container(
              ...
              child: DataTable(
                ...
                rows: [
                  DataRow(cells: [
                    DataCell( Container(width:65,child: const Text('Name',style: TextStyle(fontSize: 13),)),),
                    const DataCell(Text(":")),
                  ...
                  DataRow(cells: [
                    ...
                    const DataCell(Text(":")),
                    DataCell(Container(width: MediaQuery.of(context).size.width*0.6,child: Text(result[index].strpin.toString(),style: TextStyle(fontSize: 13)))),
                  ]),
                ],
              ),
            ),
              ...
              child: DataTable(
                ...
                rows: [
                  DataRow(cells: [
                    ...
                    const DataCell(Text(":")),
                    DataCell(Container(width:MediaQuery.of(context).size.width*0.6,child: Text(result[index].bWebsite.toString(),style: TextStyle(fontSize: 13),))),
                  ]),
              ...
              child: DataTable(
                ...
                rows: [
                  ...
                  DataRow(cells: [
                    ...
                    const DataCell(Text(":")),
                    DataCell(Container(width:MediaQuery.of(context).size.width*0.6,child: Text(result[index].natCity.toString(),style: TextStyle(fontSize: 13)))),
                  ]),
                  DataRow(cells: [
                      ...
                      child: DataTable(
                        ...
                        rows: [
                          ...
                          DataRow(cells: [
                            ...
                            const DataCell(Text(":")),
                            DataCell(Container(width:MediaQuery.of(context).size.width*0.6,child: Text(result[index].familyinfo![index1].dob.toString(),style: TextStyle(fontSize: 13)))),
                          ]),
                          DataRow(cells: [
