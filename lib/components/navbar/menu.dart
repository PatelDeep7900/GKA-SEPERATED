...
import 'package:gka/components/menupage/profilepage.dart';
        ...
        children: [
          ...
          Card(
            child: ListTile(
              ...
              title: Text('Home'),
              onTap: () {
                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => welcomepage1(),));
